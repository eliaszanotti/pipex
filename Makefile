...
#    Updated: 2022/12/06 14:53:51 by ezanotti         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
S_SRC	= ${DIR_SRC}ft_struct_init.c ${DIR_SRC}ft_conversion.c \
		  ${DIR_SRC}main.c ${DIR_SRC}ft_get_path.c ${DIR_SRC}ft_pipe.c \
		  ${DIR_SRC}ft_free_args.c
